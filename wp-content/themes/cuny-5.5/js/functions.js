jQuery(function($){
    ...
    $('.menu-toggle').on('click', function(e) {
        ...
        // Rotate the arrows
        $(this).siblings('i').toggleClass('cuny-icon-up').toggleClass('cuny-icon-down');
        $(this).parent().siblings().each(function(){
            $(this).find('i').addClass('cuny-icon-down').removeClass('cuny-icon-up');
        });
    ...
    $('.close-sliding-nav').click(function(e){
        ...
        $('.menu-toggle').siblings('i').each(function(){
            $(this).addClass('cuny-icon-down').removeClass('cuny-icon-up');
        });
    });
